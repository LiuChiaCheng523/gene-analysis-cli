...
Additional folders used by the newer overlap and pathway scripts:

```text
/mnt/data/ai_agent/gene_analysis/overlap/<project_name_overlap>/
/mnt/data/ai_agent/gene_analysis/pathway/GOBP/<project_name_overlap>/
/mnt/data/ai_agent/gene_analysis/pathway/KEGG/<project_name_overlap>/
/mnt/data/ai_agent/gene_analysis/pathway/log/<project_name_overlap>/
```
